...
class AllegroRightHand(GripperModel):
    ...
    def __init__(self, idn=0):
        super().__init__(xml_path_completion("grippers/wonik_allegro_2.xml"), idn=idn)
    ...
    def grasp_qpos(self):
        ...
        #                         1: close_pose
        #                     }
        # 1: np.array([0.0, 6.1534458e-01,  6.1530596e-01,  8.7849981e-01,
        #             0.0,  6.1545748e-01,  6.1515224e-01,  8.7843519e-01,
        #             0.0,  6.1551499e-01,  6.1511248e-01, 8.7842453e-01,
        #             0.263, 0 , 0 ,0]),  # close  # pre-grasp
        # 1: np.array([0.0, 6.1534458e-01,  6.1530596e-01,  8.7849981e-01,
        #             0.0,  6.1545748e-01,  6.1515224e-01,  8.7843519e-01,
        #             0.0,  6.1551499e-01,  6.1511248e-01, 8.7842453e-01,
        #             0.263, 0 , 0 ,0]),  # close  # pre-grasp
