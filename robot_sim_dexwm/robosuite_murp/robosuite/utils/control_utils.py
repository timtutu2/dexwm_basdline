...
def nullspace_torques(mass_matrix, nullspace_matrix, initial_joint, joint_pos, joint_vel, joint_kp=10):
    ...
    # joint_min_limits = np.array([-2.7437, -1.7837, -2.9007, -3.0421, -2.8065, 0.5445, -3.0159])
    # joint_max_limits = np.array([2.743, 1.7837, 2.9007, -0.151, 2.8065, 4.5169, 3.0159])
    # initial_joint = np.array([ 0.14936262,
    #             -0.65780519,
    #             -0.26952777,
    #             -2.65130757,
    #             0.6578265,
